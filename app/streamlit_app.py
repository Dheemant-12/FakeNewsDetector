...
if metrics is not None:
    ...
    st.info(
        "These metrics were calculated during model evaluation and saved for fast access."
    )
    ...
    if not is_valid:
        ...
        try:
            ...
            if confidence >= 95:
                ...
                st.info(
                    "The model is reasonably confident about this prediction."
                )
            else:
                st.warning(
